...
//! Function that writes to the output information on the vertices of a voxel on a given position.
...
//! Function that writes to the output information on the faces of a voxel on a given position.
